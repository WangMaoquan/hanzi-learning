...
const themeColors: Record<ThemeName, Record<string, string>> = {
  ...
  starry: {
    ...
    '--color-primary-100': '#252552',
    '--color-primary-200': '#2d2d63',
    '--color-primary-300': '#3730A3',
    '--color-primary-400': '#4338CA',
    '--color-primary-500': '#4F46E5',
    '--color-primary-600': '#6366F1',
    '--color-primary-700': '#818CF8',
    '--color-primary-800': '#A5B4FC',
    '--color-primary-900': '#C7D2FE',

    // 辅助色 - 深靛蓝（深色主题使用更深的颜色）
    '--color-secondary-50': '#1E293B',
    '--color-secondary-100': '#1a2340',
    '--color-secondary-200': '#252d52',
    '--color-secondary-300': '#2d3661',
    '--color-secondary-400': '#3b4a7d',
    '--color-secondary-500': '#4F46E5',
    '--color-secondary-600': '#6366F1',
    '--color-secondary-700': '#818CF8',
    '--color-secondary-800': '#A5B4FC',
    '--color-secondary-900': '#C7D2FE',
    '--color-secondary-950': '#E0E7FF',
